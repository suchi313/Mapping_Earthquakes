...
// Deliverable 3- adding a third map style
...
let majorEQPast7 = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson"

d3.json(majorEQPast7).then(function(data) {
